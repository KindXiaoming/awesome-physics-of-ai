...
hero:
  name: "Awesome Physics of AI"
  text: "Learning Mechanics"
  tagline: A curated list of papers leveraging physics principles to understand, predict, and decode deep learning.
  actions:
    - theme: brand
      text: Explore Papers
      link: /solvable-settings
    - theme: alt
      text: View on GitHub
...
features:
  - title: 1. Solvable Idealized Settings
    details: Exploring micro-models where learning dynamics simplify exactly, including deep linear networks and kernel methods.
    link: /solvable-settings
  - title: 2. Tractable & Simplifying Limits
    details: Analyzing systems at infinite width or depth limits to reveal mean-field behaviors and the lazy vs. rich dichotomy.
    link: /tractable-limits
  - title: 3. Macroscopic Empirical Laws
    details: Capturing reproducible empirical regularities like neural scaling laws, neural collapse, and the edge of stability.
    link: /empirical-laws
  - title: 4. Hyperparameter Disentanglement
    details: Demystifying optimization parameters via continuous effective flows and width/depth scaling theories (like µP).
    link: /hyperparameters
  - title: 5. Universal Phenomena
    details: Investigating why disparate architectures and data modalities converge toward shared Platonic representations.
    link: /universal-phenomena
---

<div style="max-width: 768px; margin: 0 auto; padding: 3rem 1.5rem; font-size: 1.1rem; line-height: 1.7;">
...
* **Hyperparameter Disentanglement**: Mapping optimization parameters using SDE noise physics and $\mu$P scaling rules.
